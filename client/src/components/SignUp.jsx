...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("https://authentication-app-api-rouge.vercel.app/auth/signup", {method: 'POST', headers: {'Content-Type': 'application/json'},body: JSON.stringify(SignUp)});
